...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_train_path', type=str, default='syntheticDatasetDiverseTripartiteNew.pt', help='path to file')
    parser.add_argument('--data_test_path', type=str, default='syntheticDatasetRERSTripartite.pt', help='path to file')
